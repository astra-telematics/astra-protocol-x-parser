...
export class ProtocolXReport
{
    ...
    public digitals?: ProtocolXDigitals;
    public analogues?: ProtocolXAnalogues;
    public driverBehaviour?: ProtocolXDriverBehaviour;
    public signalQuality?: ProtocolXSignalQuality;
    ...
    public obdInJourneyData?: ProtocolXObdInJourneyData;
    public obdDtcCodes?: ProtocolXObdDtcCodes;
    public fmsJourneyStopData?: ProtocolXFmsJourneyStopData;
    public obdJourneyStopData?: ProtocolXObdJourneyStopData;
    public carrierTemperatureData?: ProtocolXCarrierTemperatureData;
    public oneWireTemperatureProbe?: ProtocolXOneWireTemperatureProbe;
    public carrierTwoWayAlarms?: ProtocolXCarrierTwoWayAlarms;
    public rayvoltEBicycle?: ProtocolXRayvoltEBicycle;
    public econ3Byte?: ProtocolXEcon3Byte;
    public gritterDataBsEn15430?: ProtocolXGritterDataBsEn15430;
    public beacons?: ProtocolXBeacons;
    public redforgeWeight?: ProtocolXRedforgeWeight;
    public nmea2000Data?: ProtocolXNmea2000Data;
    public simSubscriberId?: ProtocolXSimSubscriberId;
    public simCardSerialNumber?: ProtocolXSimCardSerialNumber;
    public fmsDriverId?: ProtocolXFmsDriverId;
    public fmsInJourneyHighRes?: ProtocolXFmsInJourneyHighRes;
    public fmsDriverWorkingStates?: ProtocolXFmsDriverWorkingStates;
    public segwayNinebotEs4Sharing?: ProtocolXSegwayNinebotEs4Sharing;
    public sensors?: ProtocolXSensors;
    public goingGreenTheCoreBikeData?: ProtocolXGoingGreenTheCoreBikeData;
    public ecooterScooterData?: ProtocolXEcooterScooterData;
    public torrotMuviScooterData?: ProtocolXTorrotMuviScooterData;
    public ecooterSerialNumbers?: ProtocolXEcooterSerialNumbers;
    public askollEs2ScooterData?: ProtocolXAskollEs2ScooterData;
    public cashInTransitStatus?: ProtocolXCashInTransitStatus;
    public torrotMuviBatteryData?: ProtocolXTorrotMuviBatteryData;
    public batteryUsageStatistics?: ProtocolXBatteryUsageStatistics;
    public starsAcimMotorControllerData?: ProtocolXStarsAcimMotorControllerData;
    public car2Data?: ProtocolXCar2Data;
    ...
    static fromReader (reader: any, loginData?: ProtocolXLoginData): ProtocolXReport
    {
        ...
        {
            report.devicePower = new ProtocolXDevicePower(
                reader.ReadUInt8() * 0.2,
                reader.ReadUInt8()
            )
        }
        ...
        {
            report.digitals = new ProtocolXDigitals(
                reader.ReadUInt16(),
                reader.ReadUInt16()
            )
        }
        ...
        {
            report.analogues = new ProtocolXAnalogues(
                reader.ReadUInt16(),
                reader.ReadUInt16()
            )
        }
        ...
        {
            report.driverBehaviour = new ProtocolXDriverBehaviour(
                reader.ReadUInt8() / 10,
                reader.ReadUInt8() / 10,
                reader.ReadUInt8() / 10,
                reader.ReadUInt8() / 10,
        ...
        {
            let sqByte = reader.ReadUInt8();
            report.signalQuality = new ProtocolXSignalQuality(
                sqByte & 0x0F,
                -111 + (((sqByte >> 4) & 0x0F) * 4)
            )
        }
        ...
        {
            report.gsmNetworkInfo = new ProtocolXGsmNetworkInfo(
                reader.ReadUInt16(),
                reader.ReadUInt16()
            )
        }
        ...
        {
            report.geofences = new ProtocolXGeofences(
                reader.ReadUInt8()
            )
        }
        ...
        {
            let src: ProtocolXDriverIdSource = ProtocolXDriverIdSource.NONE;
        ...
        {
            report.fmsJourneyStartData = new ProtocolXFmsJourneyStartData(
                reader.ReadUInt16()
            )
        }
        ...
        if ((moduleMask & ProtocolXGnssStopReportData.mask) === ProtocolXGnssStopReportData.mask)
        {
            ...
            report.gnssStopReportData = new ProtocolXGnssStopReportData(
                lifetimeOdoKm,
                reader.ReadUInt16()
            )
        }
        ...
        {
            report.fmsInJourneyData = new ProtocolXFmsInJourneyData(
                reader.ReadUInt8(),
                reader.ReadUInt8(),
                reader.ReadUInt8() * 32,
                reader.ReadUInt8() * 32,
        ...
        {
            report.obdInJourneyData = new ProtocolXObdInJourneyData(
                reader.ReadUInt8(),
                reader.ReadUInt8(),
                reader.ReadUInt8() * 32,
                reader.ReadUInt8() * 32,
        ...
        {
            report.obdDtcCodes = new ProtocolXObdDtcCodes(
        ...
        if ((moduleMask & ProtocolXFmsJourneyStopData.mask) === ProtocolXFmsJourneyStopData.mask)
        {
            ...
            report.fmsJourneyStopData = new ProtocolXFmsJourneyStopData(
                lifetimeOdoKm,
                reader.ReadUInt16(),
                reader.ReadUInt16(),
                reader.ReadUInt16() / 10,
        ...
        if ((moduleMask & ProtocolXObdJourneyStopData.mask) === ProtocolXObdJourneyStopData.mask)
        {
            ...
            report.obdJourneyStopData = new ProtocolXObdJourneyStopData(
                lifetimeOdoKm,
                reader.ReadUInt16(),
                reader.ReadUInt16(),
                reader.ReadUInt16()
        ...
        {
            report.oneWireTemperatureProbe = new ProtocolXOneWireTemperatureProbe(
        ...
        {
            report.econ3Byte = new ProtocolXEcon3Byte(
                readU24(reader)
            )
        }
        ...
        {
            report.gritterDataBsEn15430 = new ProtocolXGritterDataBsEn15430(
                reader.ReadUInt8(),
                reader.ReadUInt8(),
                reader.ReadUInt8() / 10,
                reader.ReadUInt8()
        ...
        {
            report.redforgeWeight = new ProtocolXRedforgeWeight(
                reader.ReadUInt8(),
                reader.ReadUInt8(),
                reader.ReadUInt8(),
                reader.ReadUInt8(),
        ...
        {
            report.simSubscriberId = new ProtocolXSimSubscriberId(
                reader.ReadBytes(7)
            )
        }
        ...
        {
            report.simCardSerialNumber = new ProtocolXSimCardSerialNumber(
        ...
        {
            report.fmsDriverId = new ProtocolXFmsDriverId(
        ...
        {
            report.fmsInJourneyHighRes = new ProtocolXFmsInJourneyHighRes(
                reader.ReadUInt8(),
                reader.ReadUInt8(),
                reader.ReadUInt8() * 32,
                reader.ReadUInt8() * 32,
        ...
        else if ((moduleMask & ProtocolXSensors.mask) === ProtocolXSensors.mask)
        {
            ...
            for (let i = 0; i < 6; i++)
            {
                ...
                let rawType = b1 & 0x0F;
                let sensor = new ProtocolXSensor(
                    i,
                    rawType === 1 ? ProtocolXSensorType.TEMPERATURE 
                        : rawType === 2 ? ProtocolXSensorType.HUMIDITY 
                        : rawType === 3 ? ProtocolXSensorType.LIGHT
                        : ProtocolXSensorType.UNASSIGNED,
                    (b1 & 0xF0) !== 0
                );
        ...
        {
            report.torrotMuviBatteryData = new ProtocolXTorrotMuviBatteryData(
        ...
        {
            report.batteryUsageStatistics = new ProtocolXBatteryUsageStatistics(
                readU24(reader),
                readU24(reader),
                readU24(reader),
                readU24(reader),
        ...
        {
            report.starsAcimMotorControllerData = new ProtocolXStarsAcimMotorControllerData(
                reader.ReadInt16(),
                reader.ReadInt16(),
                reader.ReadInt16(),
                reader.ReadInt16(),
        ...
        {
            report.car2Data = new ProtocolXCar2Data(
                reader.ReadUInt16(),
                reader.ReadUInt8(),
                reader.ReadUInt8(),
                reader.ReadUInt16(),
        ...
        {
            report.gnssExtendedData = new ProtocolXGnssExtendedData(
                reader.ReadUInt32(),
                reader.ReadInt32(),
                reader.ReadInt32(),
                reader.ReadUInt8() * 2,
        ...
        {
            const beacons = new ProtocolXBeacons();
            beacons.beacons = [];
            ...
            while (beaconsBytesUsed < beaconsBytesLength && beacons.beacons.length < beaconCount)
            {
                ...
                const beacon = new ProtocolXBeacon();
        ...
        if ((moduleMask & ProtocolXAstraGenericDebugData.mask) === ProtocolXAstraGenericDebugData.mask)
        {
            ...
            switch (payloadType)
            {
                case ProtocolXAstraDebugDataType.NV_DATA:
                    ...
                    report.astraGenericDebugData.nvData = new ProtocolXAstraDebugNvData(
                        readU16BE(reader),
                        readU32BE(reader),
                        readU32BE(reader)
                    );
